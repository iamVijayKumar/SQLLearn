...
insert into products(name,price,product_origin)
 values('Espresso',2.50,'Brazil');
 
 insert into products(name,price,product_origin)
  values('Machhaito',8.00,'Brazil'),('Capaccino',9.50,'Cost RIca');
 --------------------------------- 
  update products
  set product_origin='America'
  where product_id=8;
update products
set product_origin='America',price='8.00'
where product_id=4;
select * from products;
set SQL_SAFE_UPDATES=0;
update products
set product_origin='Columbia'
where product_origin='Brazil';
  -------------------------------
